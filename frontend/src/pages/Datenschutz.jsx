  ...
  return (
    <main className="legal">
      ...
      <div className="legal__inner">
        ...
        <p className="legal__meta">Zuletzt aktualisiert: Juni 2026</p>

        {/* ── 1 ── */}
        <hr className="legal__divider" />
        <section className="legal__section">
          <h2 className="legal__h2">1. Datenschutz auf einen Blick</h2>

          <h3 className="legal__h3">Allgemeine Hinweise</h3>
          ...
          <h3 className="legal__h3">Datenerfassung auf dieser Website</h3>
          <p className="legal__p">
          ...
          <p className="legal__p">
            ...
            gewährleisten. Andere Daten werden zur Bearbeitung Ihrer Kontaktanfragen genutzt.
          </p>
          <p className="legal__p">
        ...
        <section className="legal__section">
          ...
          <h3 className="legal__h3">Externes Hosting</h3>
          <p className="legal__p">
          ...
          <p className="legal__p">
            ...
            Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG. Um die datenschutzkonforme
            Verarbeitung zu gewährleisten, haben wir einen Vertrag über Auftragsverarbeitung mit
        ...
        <hr className="legal__divider" />
        <section className="legal__section">
          <h2 className="legal__h2">3. Allgemeine Hinweise und Pflichtinformationen</h2>

          <h3 className="legal__h3">Datenschutz</h3>
          <p className="legal__p">
          ...
          <h3 className="legal__h3">Hinweis zur verantwortlichen Stelle</h3>
          <p className="legal__p">
          ...
          <h3 className="legal__h3">SSL- bzw. TLS-Verschlüsselung</h3>
          <p className="legal__p">
        ...
        <hr className="legal__divider" />
        <section className="legal__section">
          <h2 className="legal__h2">4. Datenerfassung auf dieser Website</h2>
